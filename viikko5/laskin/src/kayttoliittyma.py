...
class Summa:
    def __init__(self, logic, io):
        self.io = io
        self.logic =logic

    def suorita(self):
        edelliset.append(self.logic.tulos)
        self.logic.plus(int(self.io()))
...
class Kumoa:
    ...
    def suorita(self):
        self.logic.aseta_arvo(edelliset.pop())
        if len(edelliset)==0:
            edelliset.append(0)
